...
// Source: hermes-agent@9be83728 hermes_cli/config.py
// Keys: 239
...
export const SCHEMA: Record<string, ConfigSchemaEntry> = {
  ...
  "display.busy_input_mode": {"type":"str","default":"interrupt","doc":"","group":"display","effect":"live"},
  ...
  "tts.provider": {"type":"str","default":"edge","doc":"\"edge\" (free) | \"elevenlabs\" (premium) | \"openai\" | \"xai\" | \"minimax\" | \"mistral\" | \"neutts\" (local)","group":"tts","effect":"live"},
